...
| M1-002 | DONE | current-session | M4 reporting backend; backend/internal/reporting, backend/cmd/api/main.go | Trial balance and profit/loss endpoints behind auth middleware | backend/internal/reporting/{handler,helpers}.go; backend/cmd/api/main.go | `go vet ./...`, `go test ./...`, `go build ./...` pass | Add balance-sheet and cash-flow endpoints |
